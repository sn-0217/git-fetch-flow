...
import { ArrowLeft, Info, List, Shield, Zap, FileText, AlertTriangle, RefreshCw, Wifi, WifiOff, Code, Cpu } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3" data-section="header-actions">
              <Badge className={`gap-2 px-3 py-1.5 font-semibold hover:scale-105 transition-all duration-300 shadow-sm hover:shadow-md text-sm ${
                currentEnv === 'DEV' 
