        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge className="gap-2 px-3 py-1.5 bg-gradient-to-r from-emerald-100 to-green-100 text-emerald-700 border-emerald-200 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105">
                <Server className="w-4 h-4" />
                {currentEnv}
              </Badge>
              <Badge className="gap-2 px-3 py-1.5 bg-gradient-to-r from-amber-100 to-yellow-100 text-amber-700 border-amber-200 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className={`grid w-full ${isAdmin ? 'grid-cols-5' : 'grid-cols-2'} max-w-lg`}>
            <TabsTrigger value="applications" className="gap-2 bg-gradient-to-r from-purple-50 to-blue-50 hover:from-purple-100 hover:to-blue-100 border-purple-200 text-purple-700 font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105">
              <Power className="w-4 h-4" />
              Applications
            </TabsTrigger>
            <TabsTrigger value="submissions" className="gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 hover:from-emerald-100 hover:to-teal-100 border-emerald-200 text-emerald-700 font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105">
